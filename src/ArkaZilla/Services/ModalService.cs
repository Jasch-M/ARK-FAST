...
public class ModalService
{
    ...
    {
        Console.WriteLine("ModalService initialized");
    }

    internal static void Initialize()
    {
        Console.WriteLine("Initializing ModalService");
        Console.WriteLine($"Handlers: {Instance.Handlers.Count}");
        Console.WriteLine($"Button Handlers: {Instance.ButtonHandlers.Count}");
    }
    ...
    {
        Console.WriteLine($"Handling button {component.Data.CustomId}");
        if (Instance.ButtonHandlers.TryGetValue(component.Data.CustomId, out Func<SocketMessageComponent, Task>? buttonHandler))
        {
            Console.WriteLine($"Found handler for button {component.Data.CustomId}");
            return buttonHandler(component);
        }

        Console.WriteLine($"No handler found for button {component.Data.CustomId}");
        return Task.CompletedTask;
    }
